...
* 
*/
class TrackRecordsController extends BaseController
{
    ...
    public function setSubPages () {
        ...
        $this->subpage_list = array (
			array(
				...
				'page_title' =>  'Track Records',
				'menu_title' =>  'Track Records',
				'capability' =>  'manage_options',
				'menu_slug'  =>  'club_records_track',
				'callback'   =>  function() { echo '<h1>WP Club Records - Track</h1>'; }
			)
          );
